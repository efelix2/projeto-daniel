...
<head>
    ...
    <script>
        ...
        function psqNConforme(nrodoc, produto, tpdoc) {
            ...
            limpar();
            $.ajax({
                url: "http://localhost/git/index.php/INT_ANC/ANC/psqNConforme",
                type: "POST",
                dataType: 'json',
                data: {
                    nrodoc: nrodoc,
        ...
        function BuscTpDoc(value) {
            $.ajax({
                url: "http://localhost/git/index.php/INT_ANC/ANC/BuscTpDoc",
                type: "POST",
                dataType: 'json',
                data: {
                    value: value
        ...
        function buscaNChapa(value) {
            if (value == '') {
                ...
                $.ajax({
                    url: "http://localhost/git/index.php/INT_ANC/ANC/buscaNChapa",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        value: value.replace(/-/g, "")
        ...
        function validaNroDoc(value) {
            if (value === 0) {
                ...
                $.ajax({
                    url: "http://localhost/git/index.php/INT_ANC/ANC/validaNroDoc",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        value: value
...
<body style="overflow: visible;">
    ...
    <div class="container-fluid">
        ...
        <!-- <table id="tbl_Defeitos" data-toggle="table" data-pagination="true" data-search="true" data-toolbar="#toolbar" data-url="<?php //echo base_url('/INT_ANC/ANC/retornoRegistroRefugo'); 
                                                                                                                                        ?>" -->
        <table id="tbl_Defeitos" class="table table-dark" data-toggle="table" data-pagination="true" data-search="true" data-toolbar="#toolbar" data-url="<?php echo base_url('/INT_ANC/ANC/retornoRegistroRefugo'); ?>">
            <thead>
                <tr>
                    ...
                    <th data-halign="center" data-align="left" data-field="defeito" class="text-uppercase">DEFEITO</th>
                </tr>
            </thead>
        </table>
    </div>
